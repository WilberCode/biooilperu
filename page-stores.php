...
<div class="container ">
    <div class="max-w-[1076.5328px] mx-auto">
      ...
      <?php if(get_field('biooil_online_titulo')){?>
            <h2 class=" text-base md:text-[21px] font-bold bg-primary-500 text-white bg-opacity-[55%] tracking-wider inline-flex pl-4 sm:pl-[68px] py-1 pr-8  maxsm:mt-[24px]  " ><?php the_field('biooil_online_titulo');?></h2>
          <?php }?>
          ...
          <?php if(get_field('biooil_tiendas_titulo')){?>
            <h2 class=" text-base md:text-[21px] font-bold bg-primary-500 text-white bg-opacity-[55%] tracking-wider inline-flex pl-4 sm:pl-[68px] py-1 pr-8   " ><?php the_field('biooil_tiendas_titulo');?></h2>
          <?php }?>
        ...
        <h2 class=" text-base md:text-[21px] font-bold bg-primary-500  text-white bg-opacity-[55%] tracking-wider inline-flex  pl-4 sm:pl-[68px] py-1 pr-8   mt-[40px] " ><?php the_field('biooil_tiendas_region_titulo');?></h2> <br>
      <?php }?>
